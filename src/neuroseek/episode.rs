...
pub struct NeuroSeekEpisodeMetrics {
    ...
    /// (Only counts reductions; expressed as positive delta.)
...
/// These are generated by prompts, but stored as structured text so they can
/// be versioned and traced back to the metrics that triggered them.
#[derive(Debug, Clone, Serialize, Deserialize)]
...
pub struct ForgivenessReflection {
    /// Which sites attempted change, what fraction of prior damage was reduced.
    pub what_attempts: String,
    /// Did redemptive deeds reduce global bioload and consent breaches enough?
    pub so_what_evidence: String,
    /// Under what conditions will the system treat similar deeds as forgiven?
